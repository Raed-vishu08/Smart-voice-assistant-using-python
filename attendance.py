# -*- coding: utf-8 -*-
"""
Created on Thu Jan 14 18:08:37 2021
...
encoder_model = 'attendance/model/facenet_keras.h5'
#speak(" please enter the path of student details\n")
people_dir = 'attendance/people'
encodings_path = 'attendance/encodings/encodings.pkl'
speak('a note is here for you please check that csv file named attendance created before the task is being performed')
print('WARNING !!!!...a note is here for you please check that csv file named attendance created before the task is being performed')
time.sleep(30)
speak("please wait!! let me take care of your class attendance \n")
...
speak('hope you satisfied with my attendance service')