...
webcam_video_stream = cv2.VideoCapture('D:/python project/Face Recognition using Deep Learning with  Python-20200605T075213Z-001/Face Recognition using Deep Learning with  Python/code/images/testing/modi.mp4')
